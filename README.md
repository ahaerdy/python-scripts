...
| [youtube_scrapper](https://github.com/ahaerdy/python-scripts/tree/main/youtube_scrapper) | Extrator de dados de vídeos em playlists do YouTube. | Em breve | Novos scripts serão adicionados regularmente. |
